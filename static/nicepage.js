        ...
        ! function (a, factory) {
            ...
            var t = function (template, t, items, e) {
                ...
                var l = function () {
                    ...
                    se = 0,
                    le, ue, fe, ce, pe, ve, ge, ye, we, be, _e, xe = {
                        x: 0,
                        y: 0
                    },
                    Ce, Te, Se = {
                    ...
                    ke, Ie, Ee, Oe, Le, Fe = function (t, e) {
                        ...
                        if (!B)
                            if (t.type.indexOf("touch") > -1) {
                                if (t.touches && t.touches.length > 0)
                                    if (Ge[0] = Ve(t.touches[0], Xe), t.touches.length > 1) Ge[1] = Ve(t.touches[1], Ke)
                    ...
                    publicMethods: {
                        initHistory: function () {
                            if (i.extend(s, zi, true), s.history) {
                                ...
                                if (index > -1)
                                    if ("&" === ($i = $i.substring(0, index)).slice(-1)) $i = $i.slice(0, -1);
                                setTimeout((function () {
                    ...
                    rt = function () {
                        ...
                        for (Nt = l.max(Nt, xt()), h = 0, p = Dt.length; h < p; h++) {
                            for (s = 0, u = (a = (i = Dt[h]).keyFrames).length; s < u; s++)
                                if (v = e[(c = a[s]).constant] || 0, c.isEnd) c.frame = Nt - c.offset + v;
                            i.keyFrames.sort(Ot)
                        }
                    },
                    at = function (t, e) {
    ...
    7505: function (t, e, i) {
        ...
        ! function (e, factory) {
            ...
            var s = i.documentElement,
                ...
                E, O, L, F, M, z, N, P = function (t, simple) {
